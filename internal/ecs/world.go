...
// AddStairway adds a Stairway component to an entity.
func (w *World) AddStairway(entity Entity, stairway components.Stairway) {
	w.Masks[entity] |= components.MaskStairway
